...
library MerkleMountainRange {
    ...
    function subtreeHeights(uint256 leavesLength) public pure returns (uint256[] memory) {
     ...
     * @dev Used publicly to calculate the indices of the parent nodes of the provided proof nodes
