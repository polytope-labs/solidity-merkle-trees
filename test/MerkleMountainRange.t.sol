...
contract MerkleMountainRangeTest is Test {
    ...
    function testMerkleMountainRange() public {
        ...
        leaves[0] = MmrLeaf(2, 3, 0x2b97a4b75a93aa1ac8581fac0f7d4ab42406569409a737bdf9de584903b372c5);
        leaves[1] = MmrLeaf(5, 8, 0xd279eb4bf22b2aeded31e65a126516215a9d93f83e3e425fdcd1a05ab347e535);
        leaves[2] = MmrLeaf(0, 15, 0x38e18ac9b4d78020e0f164d6da9ea61b962ab1975bcf6e8e80e9a9fc2ae509f8);
        leaves[3] = MmrLeaf(2, 18, 0x1a3930f70948f7eb1ceab07ecdb0967986091fd8b4b4f447406045431abd9795);
        leaves[4] = MmrLeaf(0, 22, 0xe54ccfb12a140c2dddb6cf78d1c6121610260412c66d00658ed1267863427ab9);

        // Check for calculated vs expected root.
        bytes32 root = CalculateRoot(proof, leaves, treeSize);
